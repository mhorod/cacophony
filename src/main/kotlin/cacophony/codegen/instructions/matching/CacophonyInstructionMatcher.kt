...
class CacophonyInstructionMatcher : InstructionMatcher {
    private val valuePatterns: List<ValuePattern> = cacophony.codegen.patterns.cacophonyPatterns.valuePatterns
    private val sideEffectPatterns: List<SideEffectPattern> = cacophony.codegen.patterns.cacophonyPatterns.sideEffectPatterns
    private val conditionPatterns: List<ConditionPattern> = cacophony.codegen.patterns.cacophonyPatterns.conditionPatterns
